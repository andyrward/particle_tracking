...
def generate_strings_stack(
    ...
    *,
    ...
    frames_post: int = 100,
    offsets_a: Sequence[int] = (0, 8, 16, 24),
    offsets_b: Sequence[int] = (0, 8, 18, 26),
    psf_sigma: float = 2,
    ...
    # use floating-point centers with random fractional offsets to avoid peaks at integer coordinates
    xs = rng.integers(margin, width - margin, size=n_strings) + rng.uniform(0, 1, size=n_strings)
    ys = rng.integers(margin, height - margin, size=n_strings) + rng.uniform(0, 1, size=n_strings)
